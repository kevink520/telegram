...
var DashboardController = Ember.ArrayController.extend({
	needs: ['application'],
	sessionId: function() {
		return this.get('controllers.application.sessionId');
	}.property('controllers.application.sessionId'),
	sessionName: function() {
		return this.get('controllers.application.sessionName');
	}.property('controllers.application.sessionName'),
	newPostBody: '',
